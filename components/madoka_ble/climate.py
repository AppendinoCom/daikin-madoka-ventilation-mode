"""ESPHome climate platform for Madoka BLE."""
...
MadokaClimate = madoka_ble_ns.class_(
    "MadokaClimate", climate.Climate, cg.Component
)

CONF_MADOKA_BLE_ID = "madoka_ble_id"

CONFIG_SCHEMA = (
    climate.climate_schema(MadokaClimate)
    .extend(
        {
